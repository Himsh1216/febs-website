...
const Card = React.forwardRef(({ className, ...props }, ref) => (React.createElement("div", { ref: ref, className: cn("rounded-xl border border-zinc-200 bg-white text-zinc-950 shadow dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-50", className), ...props })));
...
const CardDescription = React.forwardRef(({ className, ...props }, ref) => (React.createElement("div", { ref: ref, className: cn("text-sm text-zinc-500 dark:text-zinc-400", className), ...props })));
