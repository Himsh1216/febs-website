            ...
            React.createElement("section", { className: "relative bg-gradient-to-r from-[#28d4a5] via-[#1f78d1] to-[#003f6f] text-white py-32 overflow-hidden" },
                ...
                React.createElement("div", { className: "container mx-auto px-4 relative z-10" },
                    React.createElement("div", { className: "max-w-3xl" },
                        ...
                        React.createElement("p", { className: "text-xl md:text-2xl mb-8 text-gray-200" },
            ...
            React.createElement("section", { className: "container mx-auto px-4 py-16" },
                React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8" },
                    [
                        ...
                        React.createElement(Card, { key: index, className: "group hover:shadow-xl transition-all duration-300 border-t-4 border-[#28d4a5]" },
                ...
                React.createElement("div", { className: "container mx-auto px-4" },
                    React.createElement("div", { className: "max-w-4xl mx-auto text-center mb-16" },
                        ...
                        React.createElement("p", { className: "text-xl text-gray-600" },
                            "Bridging the gap between business and science, fostering innovation and collaboration across disciplines.")),
                        ...
                        React.createElement("div", { className: "space-y-8" },
                            React.createElement("div", { className: "grid grid-cols-2 gap-6" },
                                [
                                    ...
                                    React.createElement("div", { key: index, className: "p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow" },
                ...
                React.createElement("div", { className: "container mx-auto px-4" },
                    ...
                    React.createElement("div", { className: "flex justify-center gap-4 mb-8" },
                        ['all', 'workshop', 'networking'].map((tab) => (
                            React.createElement(Button, { key: tab, variant: activeTab === tab ? "default" : "outline", onClick: () => setActiveTab(tab), className: "capitalize" },
                                tab)))),
                    React.createElement("div", { className: "grid md:grid-cols-2 gap-8" },
                        upcomingEvents
                            .filter(event => activeTab === 'all' || event.category === activeTab)
                            .map((event, index) => (
                                React.createElement(Card, { key: index, className: "group hover:shadow-xl transition-all duration-300" },
                                    React.createElement(CardHeader, null,
                ...
                React.createElement("div", { className: "container mx-auto px-4" },
                    ...
                    React.createElement("div", { className: "grid md:grid-cols-3 gap-8" },
                        pastAchievements.map((achievement, index) => (
                            React.createElement(Card, { key: index, className: "group hover:shadow-xl transition-all duration-300 overflow-hidden" },
                                ...
                                React.createElement(CardContent, null,
                                    ...
                                    React.createElement("div", { className: "flex items-center justify-between text-sm text-gray-500" },
                                        ...
                                        React.createElement("div", { className: "flex items-center gap-2" },
                                            ...
                                            React.createElement("span", null, `${achievement.participants} Participants`)))))))))))));
};
