...
const Resources: React.FC = () => {
    const [activeSection, setActiveSection] = useState<"all" | "studyMaterials" | "tools" | "research">("all");
    ...
    const FilterButton: React.FC<{ title: string; value: "all" | "studyMaterials" | "tools" | "research" }> = ({ title, value }) => (
        <Button
    ...
    const ResourceCard: React.FC<{ resource: Resource; type: string; index: number }> = ({ resource, type, index }) => (
        <Card 
